...
const setAuthHeaders = (apiKey, apiVersion) => {
  let acceptHeader = apiVersion === 2 ? 'application/vnd.maxihost.v2+json' : 'application/vnd.maxihost.v1.1+json';
  return {
...
const setHttpMethods = (Maxihost, apiKey, apiVersion) => {
  Maxihost._headers = setAuthHeaders(apiKey, apiVersion);
