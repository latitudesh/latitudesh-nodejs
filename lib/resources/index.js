module.exports = LatitudeSh => {
  ...
  const billing = require('./billing/index.js')(LatitudeSh);
  ...
  const events = require('./events/index.js')(LatitudeSh);
  const storage = require('./storage/index.js')(LatitudeSh);
  const firewall = require('./firewall/index.js')(LatitudeSh);
  const virtualMachines = require('./virtual-machines/index.js')(LatitudeSh);
};
