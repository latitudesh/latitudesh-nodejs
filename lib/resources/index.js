module.exports = LatitudeSh => {
  ...
  const blockStorage = require('./block-storage/index.js')(LatitudeSh);
  const firewall = require('./firewall/index.js')(LatitudeSh);
  const virtualMachines = require('./virtual-machines/index.js')(LatitudeSh);
  const sshKeys = require('./ssh-keys/index.js')(LatitudeSh);
  const userData = require('./user-data/index.js')(LatitudeSh);
  const managedDatabases = require('./managed-databases/index.js')(LatitudeSh);
};
