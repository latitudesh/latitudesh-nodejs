...
describe('get custom script', () => {
  it('call get request with right params', async () => {
    const path = '/servers/custom_scripts/' + scriptId;
    Maxihost._get = jest.fn(() => {
      return { body: { success: true } };
    });
    maxihostApi.Server.CustomScripts.get(scriptId);
  ...
  it('call get request with wrong params', async () => {
    ...
    await maxihostApi.Server.CustomScripts.get(scriptId).catch(e => {
      expect(e).toBe(error);
    });
  });
});
...
describe('list custom script', () => {
  it('call get request with right params', async () => {
    const path = '/servers/custom_scripts/';
    Maxihost._get = jest.fn(() => {
      return { body: { success: true } };
    });
    maxihostApi.Server.CustomScripts.list(searchParams);
  ...
  it('call get request with wrong params', async () => {
    const error = new Error('Async error');
    Maxihost._get = jest.fn().mockRejectedValue(error);
    await maxihostApi.Server.CustomScripts.list().catch(e => {
      expect(e).toBe(error);
    });
  });
});
...
describe('create custom script', () => {
  it('call post request with right params', async () => {
    ...
    maxihostApi.Server.CustomScripts.create(data);
  ...
  it('call posts request with wrong params', async () => {
    ...
    await maxihostApi.Server.CustomScripts.create(data).catch(e => {
      expect(e).toBe(error);
    });
  });
});
...
describe('delete custom script', () => {
  it('call delete request with right params', async () => {
    ...
    maxihostApi.Server.CustomScripts.delete(scriptId);
  ...
  it('call delete request with wrong params', async () => {
    ...
    await maxihostApi.Server.CustomScripts.delete(scriptId).catch(e => {
      expect(e).toBe(error);
    });
  });
});
