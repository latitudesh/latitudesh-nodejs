...
Nodejs Package for interacting with Latitude.sh API. Check our [API documentation](https://docs.latitude.sh/reference)
...
- `Firewall.delete` Params: `(firewallId)`. [Reference](https://docs.latitude.sh/reference/delete-firewall)
